...
{
    // copy
    copyFile("C:\\C++\\HCMUT\\DSA\\Assignment7\\test\\solution_you\\output" + to_string(i) + ".txt", "C:\\C++\\HCMUT\\DSA\\Assignment7\\test_fail\\solution_you.txt");
    copyFile("C:\\C++\\HCMUT\\DSA\\Assignment7\\test\\solution\\output" + to_string(i) + ".txt", "C:\\C++\\HCMUT\\DSA\\Assignment7\\test_fail\\solution.txt");
    copyFile("C:\\C++\\HCMUT\\DSA\\Assignment7\\test\\input\\input" + to_string(i) + ".txt", "C:\\C++\\HCMUT\\DSA\\Assignment7\\test_fail\\input_fail.txt");
...
{
    string folder_solution_you = "C:\\C++\\HCMUT\\DSA\\Assignment7\\test\\solution_you\\output";
    string folder_solution = "C:\\C++\\HCMUT\\DSA\\Assignment7\\test\\solution\\output";
    vector<int> result;
...
int main(int argc, char *argv[])
{
    ...
    string folder_input = "C:\\C++\\HCMUT\\DSA\\Assignment7\\test\\input\\input";
    string folder_solution_you = "C:\\C++\\HCMUT\\DSA\\Assignment7\\test\\solution_you\\output";
    string folder_solution = "C:\\C++\\HCMUT\\DSA\\Assignment7\\test\\solution\\output";
